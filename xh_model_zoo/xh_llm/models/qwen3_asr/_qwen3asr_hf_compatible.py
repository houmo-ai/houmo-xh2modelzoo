...
from qwen_asr.core.transformers_backend.modeling_qwen3_asr import Qwen3ASRThinkerTextModel
...
class Qwen3ASRHFCompatible(Qwen3ASRThinkerTextModel):
    ...
    def to_hf_compatible(
        cls,
        policy: Union[Qwen3ASRThinkerTextModel, str],
