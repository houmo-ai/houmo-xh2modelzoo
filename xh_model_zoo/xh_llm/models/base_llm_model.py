...
#
# File: base_llm_model.py
# Description:
#   Base LLM model implementation with quantization support.
#   This module provides the BaseLLMModel class with support for AWQ and GPTQ
#   quantization methods, including layer conversion utilities.
#
