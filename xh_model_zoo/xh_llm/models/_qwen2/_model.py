...
@XHLLM_TRACEABLE_MODULES.register_module({transformers.Qwen2Model: "Qwen2Model"})
...
@XHLLM_TRACEABLE_MODULES.register_module({transformers.Qwen2ForCausalLM: "transformers.Qwen2ForCausalLM"})
