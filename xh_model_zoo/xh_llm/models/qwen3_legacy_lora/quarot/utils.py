...
# File: utils.py
# Description:
#   Qwen3 legacy LoRA QuaRot utility helpers adapted for the xh2 model zoo (xh2modelzoo).
...
def parser_gen():
    ...
    parser.add_argument("--shared_expert_act_calib", action="store_true", default=False)
    parser.add_argument("--other_dataset", action="store_true", default=False)
    # Rotation Arguments
    parser.add_argument("--online_hadamard", action="store_true", default=False)
    parser.add_argument(
        "--rotate",
        action="store_true",
        default=False,
    ...
    parser.add_argument("--act_order", action="store_true", default=False, help="act-order in GPTQ")
    ...
    # do smooth
    parser.add_argument("--do_smooth", action="store_true", default=False, help="smooth implement")
    # static option
    parser.add_argument("--static_test", action="store_true", default=False)
    parser.add_argument("--fully_quant", action="store_true", default=False)
