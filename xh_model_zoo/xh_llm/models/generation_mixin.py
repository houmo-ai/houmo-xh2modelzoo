...
class BaseGenerationMixin(GenerationMixin):
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if self.is_prefill:
            inputs["past_seq_length"] = 0
        else:
            inputs["past_seq_length"] = input_ids.shape[-1] - 1
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        old_input_seq_length = self.get_input_sequence_length()
        ...
        self.set_input_sequence_length(old_input_seq_length)
        if streamer is not None:
            streamer.end()
