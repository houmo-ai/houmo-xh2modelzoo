...
#
# File: mmdit_converter.py
# Description:
#   Mmdit Converter implementation.
#
...
class MMDit_ConverterXH2a(HFTransfromersConverter):
    ...
    def _convert(self, hf_model, output_dir: str, postprocess=None):
        ...
        # latent = torch.randn(1, 16, 1, 116, 208).cuda()
        latent = torch.load("xh_model_zoo/xh_llm/models/qwen_image/latent.pt")
        ...
        if True:
            with torch.no_grad():
                ...
                image = postprocess(output[:, :, 0].detach().cpu(), "pil")
