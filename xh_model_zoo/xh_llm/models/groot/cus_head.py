...
class cus_Head(Gr00tN1d6ActionHead):
    ...
    def _encode_features(
        ...
        # Embed state.
        state_features = self.state_encoder(action_input.state, embodiment_id)  # [1,1,128] [1]   embeding_state  **#
    ...
    def get_action_with_features(
        ...
        for t in range(self.num_inference_timesteps):
            ...
            # Join vision, language, state and action embedding along sequence dimension.
            sa_embs = torch.cat((state_features, action_features), dim=1) # [1, 50, 1536]
