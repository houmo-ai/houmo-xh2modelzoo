...
#
# File: deepseekv2_llm_model.py
# Description:
#   Deepseekv2 Llm Model model implementation.
#
...
class DeepseekV2LegacyModel(LLMBaseModel):
    def __init__(
        self,
        hf_model: str,
        wrap_cfg,
    ...
    def init_wrap_model(self, hf_model=None):
        from ._model_deepseekv2 import register_wrap_modules  # noqa F401
        ...
        if self.use_cache:
            ...
            only_first_block = self.wrap_cfg.get("only_first_block", False)  # default is False
    ...
    def get_hf_model(self, device_map="cpu", **kwargs):
        ...
        qwen3moe_hf_model: DeepseekV2ForCausalLM = cast(DeepseekV2ForCausalLM, hf_model)
        assert id(qwen3moe_hf_model.get_output_embeddings().weight) != id(
            qwen3moe_hf_model.get_input_embeddings().weight
        )
        return qwen3moe_hf_model
