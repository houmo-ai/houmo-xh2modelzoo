...
# 添加子模块路径
submodule_path = os.path.join("/data01/home/xuchen/Fun-Audio-Chat/third_party/CosyVoice")
sys.path.insert(0, submodule_path)
matcha_tts_path = os.path.join("/data01/home/xuchen/Fun-Audio-Chat/third_party/CosyVoice/third_party/Matcha-TTS")
...
def get_audio_detokenizer(token_hop_len=25 * 30, model_path='/data01/datasets/Fun-CosyVoice3-0.5B-2512'):
    logger.info(f"cosyvoice cuda: {torch.cuda.is_available()}")
    cosyvoice3 = CosyVoice3(model_path,
