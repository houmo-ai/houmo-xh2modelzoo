    ...
    def forward(
        ...
        if continuous_audio_features is not None:
            ...
            if self.continuous_features_mode == "add":
                ...
                assert NotImplementedError("Adding continuous features is not implemented in this version. Please set continuous_features_mode to 'replace' or remove continuous features.")
            else:
                # hidden_states[feature_exist_mask] = continuous_audio_hidden_states
