...
from .image_processing_qwen2_vl import Qwen2_5_VLImageProcessor
...
class Qwen3VLImagesKwargs(ImagesKwargs):
    ...
    return_hm_pixel_values: Optional[bool]
...
class Qwen3VLProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, video_processor=None, chat_template=None, **kwargs):
        ...
        if getattr(self.image_processor, "temporal_patch_size", None) is not None:
            self.hm_image_processor.temporal_patch_size = self.image_processor.temporal_patch_size
        ...
        shortest_edge = getattr(self.image_processor, "size", {}).get("shortest_edge", None)
        longest_edge = getattr(self.image_processor, "size", {}).get("longest_edge", None)
    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen3VLProcessorKwargs],
        ...
        if images is not None:
            ...
            hm_inputs = self.hm_image_processor.preprocess(images=images, **images_kwargs)
