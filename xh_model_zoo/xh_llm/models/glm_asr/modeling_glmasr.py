...
#
# File: modeling_glmasr.py
# Description:
#   Modeling implementation for glm_asr in HOUMO AI xh2modelzoo.
#
...
from transformers.utils import TransformersKwargs, auto_docstring, is_torch_available
from transformers.utils.generic import can_return_tuple, maybe_autocast
