...
@XHLLM_TRACEABLE_MODULES.register_module({Qwen3_5VisionAttention: "Qwen3_5VisionAttention"})
class _Qwen3_5VisionAttention(DynamicModule):
...
@XHLLM_TRACEABLE_MODULES.register_module({Qwen3_5VisionBlock: "Qwen3_5VisionBlock"})
class _Qwen3_5VisionBlock(DynamicModule):
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        pass
...
@XHLLM_TRACEABLE_MODULES.register_module({Qwen3_5VisionPatchEmbed: "Qwen3_5VisionPatchEmbed"})
class _Qwen3_5VisionPatchEmbed(DynamicModule):
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        self.only_first_block = False
        self.max_size_w = cfg.max_size_w
...
@XHLLM_TRACEABLE_MODULES.register_module({Qwen3_5VisionPatchMerger: "Qwen3_5VisionPatchMerger"})
class _Qwen3_5VisionPatchMerger(DynamicModule):
    def _setup(self, cfg: ConfigDict):
        pass
...
@XHLLM_TRACEABLE_MODULES.register_module({Qwen3_5VisionModel: "Qwen3_5VisionModel"})
class _Qwen3_5VisionModel(DynamicModule):
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        self.only_first_block = False
        self.patch_size = cfg.patch_size
