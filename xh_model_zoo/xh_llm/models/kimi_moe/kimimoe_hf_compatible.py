...
#
# File: kimimoe_hf_compatible.py
# Description:
#   HF-compatible Kimi-MoE wrapper adapted for xh2modelzoo inference.
#
...
# sys.path.append("/data01/home/xuchen/.cache/huggingface/modules/transformers_modules/kimi/") # modeling_deepseek
# from modeling_deepseek import DeepseekV3ForCausalLM

# import DeepseekV3ForCausalLM
...
class KimiMoe_HFCompatible(DeepseekV3ForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #     position_ids = position_ids + torch.range(0, seq_length + padding_len-1, dtype=torch.long, device=inputs_embeds.device).view(1, -1)
        # else:
        #     position_ids = torch.range(0, seq_length + padding_len-1, dtype=torch.long, device=inputs_embeds.device).view(1, -1)
        ...
        if steps > 1:
            ...
            for i in tqdm(range(steps)):
                ...
                output=self._llm_model.forward(
                    sub_inputs_embeds, sub_past_seq_length, sub_current_input_length, position_ids, past_key_caches, past_value_caches
                )
