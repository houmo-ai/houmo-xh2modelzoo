...
#
# File: modeling_qwen3moe_vl.py
# Description:
#   Modeling implementation for qwen3_vl_moe in HOUMO AI xh2modelzoo.
...
class Qwen3VLMoeTextDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3VLMoeTextConfig, layer_idx: int):
        ...
        self.self_attn = Qwen3VLMoeTextAttention(config=config, layer_idx=layer_idx)
...
class Qwen3VLMoeVisionModel(Qwen3VLMoePreTrainedModel):
    ...
    def forward(self, hidden_states: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        grid_thw = torch.tensor([[1, th // self.patch_size, tw // self.patch_size]]).to(hidden_states.device)
...
class Qwen3VLMoeModel(Qwen3VLMoePreTrainedModel):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor, image_grid_thw: Optional[torch.LongTensor] = None):
        ...
        image_embeds, deepstack_image_embeds = self.visual.forward_ori(pixel_values, grid_thw=image_grid_thw)
