...
#
# File: image_processing_qwen3moe_vl.py
# Description:
#   Image processing utilities for qwen3_vl_moe in HOUMO AI xh2modelzoo.
    ...
    def preprocess(
        ...
        if images is not None:
            ...
            for image in images:
                ...
                hm_pixel_values.append(torch.from_numpy(hm_patches))
            ...
            # hm_pixel_values = np.concatenate(hm_pixel_values, axis=0)
            data = {
