...
# Description:
#   Vision model implementation for HOUMO AI xh2modelzoo.
#
...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        PaddleOCRAttention: "PaddleOCRAttention",
    }
)
class _PaddleOCRAttention(DynamicModule):
    """Optimized PaddleOCRAttention with torch.fx compatible forward pass
...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        PaddleOCRMLP: "PaddleOCRMLP",
    }
)
class _PaddleOCRMLP(DynamicModule):
    """Optimized PaddleOCRMLP with simplified forward pass"""
...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        PaddleOCREncoderLayer: "PaddleOCREncoderLayer",
    }
)
class _PaddleOCREncoderLayer(DynamicModule):
    """Optimized PaddleOCREncoderLayer with simplified forward pass"""
...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        PaddleOCRVisionEmbeddings: "PaddleOCRVisionEmbeddings",
    }
)
class _PaddleOCRVisionEmbeddings(DynamicModule):
    """Optimized PaddleOCRVisionEmbeddings with simplified forward pass"""
...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        PaddleOCRVisionTransformer: "PaddleOCRVisionTransformer",
    }
)
class _PaddleOCRVisionTransformer(DynamicModule):
    """Optimized PaddleOCRVisionTransformer with simplified forward pass
