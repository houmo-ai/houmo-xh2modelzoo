...
#
# File: image_processing_paddleocr_vl.py
# Description:
#   Image processing utilities for paddleocr_vl_1_5 in HOUMO AI xh2modelzoo.
#
...
class SiglipImageProcessor(BaseImageProcessor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.size = None  # not used - custom size handling via min_pixels/max_pixels
    ...
    def _preprocess(
        ...
        # Return full resized image [1, C, H, W] instead of patchified tensor.
        # The ONNX vision model handles patchification internally via Conv2d.
        full_image = patches[:1]  # [1, C, H, W] – first temporal frame
        return full_image, (grid_t, grid_h, grid_w)
    ...
    def preprocess(
        ...
        # Note: PaddleOCR uses custom size handling via min_pixels/max_pixels instead of standard size format
        # Only validate if size is explicitly provided by caller
        if size is not None:
            validate_preprocess_arguments(
