...
class SD3LenovoHFCompatible(SD3HFCompatible):
    @classmethod
    def to_hf_compatible(
        ...
        **kwargs,
        ...
        lenovo_model_or_path: str = kwargs.get("lenovo_model", "")
        assert isinstance(hf_model_or_path, str)
        pipe = SD3LenovoDiffusion3Pipe.from_pretrained(hf_model_or_path, lenovo_model_or_path)
