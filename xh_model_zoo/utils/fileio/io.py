...
# File: io.py
# Description:
#   File I/O utilities for various storage backends.
...
def get_file_backend(
    ...
    *,
    ...
    if uri is None and "backend" not in backend_args:
        raise ValueError('uri should not be None when "backend" does not exist in ' "backend_args")
...
def rmtree(
    ...
    Examples:
        ...
        >>> rmtree(dir_path)
    """
    backend = get_file_backend(dir_path, backend_args=backend_args, enable_singleton=True)
...
def load(file, file_format=None, file_client_args=None, backend_args=None, **kwargs):
    ...
    Args:
        ...
        file_client_args (dict, optional): Arguments to instantiate a
            FileClient. See :class:`xhquant.fileio.FileClient` for details.
...
def dump(obj, file=None, file_format=None, file_client_args=None, backend_args=None, **kwargs):
    ...
    Args:
        ...
        file_client_args (dict, optional): Arguments to instantiate a
            FileClient. See :class:`xhquant.utils.fileio.FileClient` for details.
            Defaults to None. It will be deprecated in future. Please use
            ``backend_args`` instead.
        backend_args (dict, optional): Arguments to instantiate the
            prefix of uri corresponding backend. Defaults to None.
