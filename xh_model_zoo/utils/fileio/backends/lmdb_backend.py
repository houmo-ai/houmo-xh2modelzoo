...
#
# File: lmdb_backend.py
# Description:
#   LMDB storage backend for key-based file reads in xh2modelzoo file I/O.
#
...
class LmdbBackend(BaseStorageBackend):
    ...
    def _get_client(self):
        ...
        return lmdb.open(self.db_path, readonly=self.readonly, lock=self.lock, readahead=self.readahead, **self.kwargs)
