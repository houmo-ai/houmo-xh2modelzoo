...
def main(args):
    ...
    model: Qwen3ForCausalLM = AutoModelForCausalLM.from_pretrained(model_dir, torch_dtype="auto", device_map="auto")  # type: ignore
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-dir", type=str, default="./data/models/Qwen3-8B")
