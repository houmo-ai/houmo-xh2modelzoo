...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-type", type=str, default="Qwen3VLForConditionalGeneration", help="", choices=support_llm_model_types
    )
    parser.add_argument(
        "--chip-arch", type=str, default="XH2a", help="chip architecture, default is XH2a", choices=["XH2a", "YueHui"]
    )
    parser.add_argument("--model", type=str, default=None)
    parser.add_argument("--context-length", type=int, default=None, help="max context sequence length")
    parser.add_argument("--prefill-chunk-length", type=int, default=None, help="prefill chunk length")
    parser.add_argument("--quant-type", default=None, help="quant type, default is w8a8_sefp")
    parser.add_argument(
        "--quant-weight",
        type=str,
        default=None,
    ...
    parser.add_argument("--image-size-w", type=int, default=448, help="image width for vision input, default is 448")
    parser.add_argument("--image-size-h", type=int, default=448, help="image height for vision input, default is 448")
