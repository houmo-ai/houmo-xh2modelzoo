...
参考configs_merak/xh2a/llm_models/qwen3/1.7b/qwen3_1.7b_xh2a_w4a8_2k.py
...
```bash
python examples_merak/llm/llm_export_hmonnx.py --config configs_merak/xh2a/llm_models/qwen3/8b/qwen3_8b_xh2a_2k.py
或者
