...
if TYPE_CHECKING:
    from xhmodel_merak.xh_llm.models.qwen3moe import XHQwen3MoeLegacyHMONNXModel
...
def main(args):
    ...
    hmonnx_model: XHQwen3MoeLegacyHMONNXModel = AutoLLMHONNXModel.from_pretrained(model_meta_file)
    assert type(hmonnx_model).__name__ == "XHQwen3MoeLegacyHMONNXModel", (
        f"Expected model type XHQwen3MoeLegacyHMONNXModel, but got {type(hmonnx_model).__name__}"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="work_dirs/xh2a_qwen3-30b-a3b_w8a8h1_sefp_256_2k/hmquant_xh2_qwen3-30b-a3b_w8a8_256_2k_20260316/golden_meta_info.json",
    )
