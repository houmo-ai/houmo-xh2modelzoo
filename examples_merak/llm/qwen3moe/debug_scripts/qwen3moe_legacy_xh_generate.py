...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs_merak/xh2a/llm_models/qwen3moe/30b_a3b/xh2a_qwen3-30b-a3b_w8a8h1_sefp_256_2k.py",
    )
