...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a migrated SenseVoiceSmall FP32 ONNX.")
    ...
    parser.add_argument("--report", default="work_dirs/sensevoice_small_merak/report/float_report.json")
