...
#
# File: flux2_klein_export.py
# Description:
#   Example script: aigc/flux2_klein/flux2_klein_export.py
#
...
def main(args):
    ...
    cfg_name = f"{model_name}_{target_device.name}_{args.width}x{args.height}"
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        choices=["text_encoder", "transformer", "vae", "vae_decoder"],
        help="export selected Flux components",
    )
