...
T5_non_sym_2bit_v1.3.0.1.safetensors ：量化版本, 使用该权重需要使用 xh_model_zoo/xh_aigc/models/sd3_custom_a/modeling_t5.py 替换transformers库的modeling_t5.py文件
pip show transformers 获取transformers路径
cp xh_model_zoo/xh_aigc/models/sd3_custom_a/modeling_t5.py /opt/extdata/.conda/envs/xhquant/lib/python3.12/site-packages/transformers/models/t5/modeling_t5.py
