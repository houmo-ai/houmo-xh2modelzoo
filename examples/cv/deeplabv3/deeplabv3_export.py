...
#
# File: deeplabv3_export.py
# Description:
#   Example script: cv/deeplabv3/deeplabv3_export.py
#
...
def main(args):
    ...
    convert_onnx_to_hmonnx(
        onnx_file,
        [torch.randn(1, 3, 1024, 2048, dtype=torch.float32)],
        DeviceType.XH2a,
        out_hmonnx_file,
    ...
    session.step = 0
    session(torch.randn(1, 3, 1024, 2048, dtype=torch.float16).to(device))


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--onnx", type=str, default="data/models/deeplabv3_1024x2048_cityscapes.onnx")
