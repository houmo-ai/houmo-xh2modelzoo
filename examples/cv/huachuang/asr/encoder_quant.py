...
def main(args):
    ...
    convert_onnx_to_hmonnx(
        onnx_file,
        [torch.randn(1, 334, 560, dtype=torch.float16), torch.ones(1, 334, dtype=torch.float16)],
        DeviceType.XH2a,
        out_hmonnx_file,
    ...
    session(input_data, mask)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--onnx", type=str, default="/home/jiangyong.yu/.cache/modelscope/hub/models/iic/speech_seaco_paraformer_large_asr_nat-zh-cn-16k-common-vocab8404-pytorch/encoder_sim.onnx")
