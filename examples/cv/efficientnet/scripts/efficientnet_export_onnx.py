...
#
# File: efficientnet_export_onnx.py
# Description:
#   Example script: cv/efficientnet/scripts/efficientnet_export_onnx.py
#
...
if __name__ == "__main__":
    ...
    input_tensor = torch.randn(1, 3, 380, 380)

    out_onnx_file = "data/models/efficientnet/efficientnet_b4.onnx"
