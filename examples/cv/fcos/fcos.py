...
def main(args):
    ...
    convert_onnx_to_hmonnx(
        onnx_file,
        [torch.randn(1, 3, 1312, 1312, dtype=torch.float32)],
        DeviceType.XH2a,
        out_hmonnx_file,
    ...
    session.step = 0
    session(torch.randn(1, 3, 1312, 1312, dtype=torch.float16).to(device))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--onnx",
        type=str,
        default="/data01/home/xuchen/xh2/xh2_model_zoo/data/models/fcos_r50_caffe_fpn_gn-head_1x_coco.onnx",
    )
