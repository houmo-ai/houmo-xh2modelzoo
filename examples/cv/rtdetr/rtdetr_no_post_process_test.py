...
#
# File: rtdetr_no_post_process_test.py
# Description:
#   Example script: cv/rtdetr/rtdetr_no_post_process_test.py
#
...
def main(args):
    ...
    image = torch.from_numpy(image).to(torch.float16).to(device)
    ...
    scores, boxes = [o[0].cpu().numpy() for o in results]
