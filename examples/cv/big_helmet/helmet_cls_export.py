...
#
# File: helmet_cls_export.py
# Description:
#   Example script: cv/big_helmet/helmet_cls_export.py
#
...
DEFAULT_ONNX = Path(__file__).with_name("cls_efficientnetb1_helmet4_250715_01.onnx")
