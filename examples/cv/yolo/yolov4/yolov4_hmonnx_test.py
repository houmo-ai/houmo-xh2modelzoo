...
#
# File: yolov4_hmonnx_test.py
# Description:
#   Example script: cv/yolo/yolov4/yolov4_hmonnx_test.py
#
...
# --- 1. 修正后的预处理函数 ---
def preprocess_image_stretch(image, input_size):
    """
...
def main(args):
    ...
    # --- 使用修正后的预处理 ---
    results = preprocess_image_stretch(image_bgr, input_shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hmonnx", type=str, default="work_dirs/yolov4m/hmonnx/yolov4m_w8a8_XH2a.onnx"
    )  # 建议先用w8a8测试
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--image", type=str, default="data/images/zidane.jpg")
