...
#
# File: yolov4_export_resizer.py
# Description:
#   Example script: cv/yolo/yolov4/yolov4_export_resizer.py
#
...
def main(args):
    ...
    resizer_config = ResizerScheme(
        ...
        mode="nearest",
        align_corners=False,
        fmt="rgb",  # "yuv444", "yuv420", "yuv422" "rgb", "R8"
    ...
    if args.gen_golden:
        ...
        session.step = 0
        session(torch.randn(1, 3, 416, 416, dtype=torch.float16, device="cuda"))


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--onnx", type=str, default="data/models/yolov4_1_3_416_416_static_withpp.onnx")
