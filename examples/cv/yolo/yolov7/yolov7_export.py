...
#
# File: yolov7_export.py
# Description:
#   Example script: cv/yolo/yolov7/yolov7_export.py
#
...
def main(args):
    ...
    out_hmonnx_file = work_dirs / "hmonnx" / f"{onnx_name}_{args.quant_type}_{target_device}.onnx"
...
if __name__ == "__main__":
    ...
    # 修改默认的onnx文件路径为yolov7
    parser.add_argument("--onnx", type=str, default="data/models/yolo/yolov7.onnx")
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--image", type=str, default="data/images/000000001490.jpg")
    parser.add_argument("--quant-type", default="w8a16_ssfp", help="quant type, default is w8a8")
