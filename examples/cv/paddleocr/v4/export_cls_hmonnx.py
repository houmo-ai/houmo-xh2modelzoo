...
#
# File: export_cls_hmonnx.py
# Description:
#   Example script: cv/paddleocr/v4/export_cls_hmonnx.py
#
...
def main(args):
    ...
    if not os.path.exists(out_hmonnx_file):
        ...
        convert_onnx_to_hmonnx(
            onnx_file,
            [
                torch.randn(1, 3, 48, 192, dtype=torch.float32),
            ],
            DeviceType.XH2a,
            out_hmonnx_file,
            quant_config=quant_config,
            input_names=["generated_tensor_213"],
    ...
    x = np.load("/data01/home/yujy/work/OnnxOCR/cls_input.npy")
