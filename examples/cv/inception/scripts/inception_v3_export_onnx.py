...
#
# File: inception_v3_export_onnx.py
# Description:
#   Example script: cv/inception/scripts/inception_v3_export_onnx.py
#
...
if __name__ == "__main__":
    ...
    out_onnx_file = "data/models/inception/inception_v3_300x300.onnx"
