...
#
# File: qwen3_vl_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/qwen3vl/qwen3_vl_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models.spirit_vla import Qwen3_VLConvertConfig, VisualConfig
from xh_model_zoo.xh_llm.models.spirit_vla import Qwen3VLForConditionalGeneration
...
def main(args):
    ...
    policy = SpiritVLAPolicy.from_pretrained(hf_model_path)
    native_model = policy.qwen
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "Qwen3VLForConditionalGeneration_SpiritVLA", config, work_dir)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--model", type=str, default="/data01/home/she.gao/.cache/huggingface/hub/models--Spirit-AI-robotics--Spirit-v1.5/snapshots/9886fa7552de70b097c4214b7e40e66ff937a6fd")
    ...
    parser.add_argument("--image_max_size_h", type=int, default=256, help="image max size height")
    parser.add_argument("--image_max_size_w", type=int, default=320, help="image max size width")
    parser.add_argument(
        "--image_max_size_t",
        type=int,
        default=2,
