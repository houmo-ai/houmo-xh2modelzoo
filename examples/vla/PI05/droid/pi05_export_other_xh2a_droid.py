...
def run_pi05_inference(args):
    ...
    temp_onnx_action_in = "./workdir/pi0.5_action_in_proj_droid.onnx"
    simplified_onnx_action_in = "./workdir/pi0.5_action_in_proj_droid_simplified.onnx"
    ...
    temp_onnx_action_out = "./workdir/pi0.5_action_out_proj_droid.onnx"
    simplified_onnx_action_out = "./workdir/pi0.5_action_out_proj_droid_simplified.onnx"
    ...
    temp_onnx_time_mlp = "./workdir/pi0.5_time_mlp_droid.onnx"
    simplified_onnx_time_mlp = "./workdir/pi0.5_time_mlp_droid_simplified.onnx"
