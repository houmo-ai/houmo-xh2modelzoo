...
from xh_model_zoo.xh_llm.models.pi05 import XHGemma05CLLMModel
...
def main(args):
    ...
    xh_model.set_input_sequence_length(15)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/data01/home/she.gao/xh2modelzoo/examples/vla/PI05/config/droid/pi05_gemma_expert_300m_xh2a_2k_droid_mask.py",
    )
