...
#
# File: pi05_export_vision_xh2a_libero.py
# Description:
#   Export utilities for PI05 in HOUMO AI xh2modelzoo.
#
...
def run_pi05_inference(args):
    ...
    if True:
        ...
        temp_onnx_file = "./workdir/pi0.5_siglip_libero.onnx"
        simplified_onnx_file = "./workdir/pi0.5_siglip_libero_simplified.onnx"
