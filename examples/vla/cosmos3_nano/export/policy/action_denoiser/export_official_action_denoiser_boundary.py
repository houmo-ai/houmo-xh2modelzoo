...
"""Export Cosmos3-Nano policy action denoiser boundary with official host packing."""
...
from runtime.policy_runtime import (  # noqa: E402
    OfficialCosmos3ActionDenoiserBackboneWrapper,
    OfficialCosmos3ActionDenoiserBoundaryWrapper,
...
DEFAULT_OUTPUT_ROOT = _COSMOS3_ROOT / "data" / "policy_official_action_denoiser_boundary_2layers_smoke"
