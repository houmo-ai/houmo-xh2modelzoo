...
DEFAULT_INPUT = THIS_DIR / "examples.txt"
DEFAULT_ONNX_PATH = THIS_DIR / "ct_transformer.onnx"
DEFAULT_SIMPLIFIED_ONNX_PATH = THIS_DIR / "ct_transformer_simplified.onnx"
DEFAULT_WORK_DIR = REPO_ROOT / "work_dirs" / "ct_transformer"
...
def main():
    ...
    hmonnx_path = args.work_dir / "hmonnx" / f"{args.onnx_path.stem}_{fixed_length}t_{target_device}_{args.quant_type}.onnx"
    ...
    golden_dir = args.work_dir / "hmonnx" / f"{args.onnx_path.stem}_{fixed_length}t_golden" if args.save_golden else None
