...
def get_hadK(n, transpose=False):
    hadK, K = None, None
    if n % 180 == 0:  # for 2880, 5760, etc. gpt-oss model
...
def matmul_hadU(X, transpose=False):
    ...
    return input.reshape(X.shape) / torch.tensor(n).sqrt()
...
def import_fast_hadamard_transform():
    try:
        ...
        print("Package: Please install missing `fast_hadamard_transform` module via: `pip install -U git+https://github.com/Dao-AILab/fast-hadamard-transform.git --no-build-isolation -v`")
        raise e
...
# # had60.pal, had108.pal, had140.pal, had156.will, had172.will, had180.pal:
...
def get_had180():
    from .get_hadmard_matrix_from_txt import get_had180_from_file
    return get_had180_from_file("gptqmodel/quantization/rotation/had.180.pal.txt")
