...
from export_utils import resolve_encoder_onnx, resolve_manifest
from input_utils import build_encoder_inputs, ensure_file, ensure_dir, get_onnx_input_specs, resolve_path
...
def main() -> None:
    ...
    parser.add_argument("--onnx", type=str, default="", help="encoder ONNX path")
    parser.add_argument(
        "--model-dir",
        type=str,
        default="",
        help="directory containing exported encoder onnx",
    )
    parser.add_argument(
        "--export-manifest",
        type=str,
    ...
    onnx_path = resolve_encoder_onnx(args.onnx, args.model_dir, manifest_path)
    ...
    input_dict = build_encoder_inputs(onnx_path, inputs_dir, float_dtype=args.input_dtype)
    ...
    logger.info("Converting encoder ONNX to hmonnx...")
    convert_onnx_to_hmonnx(
        str(onnx_path),
        input_tensors,
        DeviceType.XH2a,
