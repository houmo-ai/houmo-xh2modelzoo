...
#
# File: Xiaomi-MiMo-VL-Miloco_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/Xiaomi-MiMo-VL-Miloco/Xiaomi-MiMo-VL-Miloco_xh2a_export_hmonnx.py
#
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="/data01/nfs_shared/llm_models/xiaomi-open-source/Xiaomi-MiMo-VL-Miloco-7B",
    )
    ...
    print("✅ debugpy listening on 0.0.0.0:2345, waiting for VSCode attach...")
