...
#
# File: paddleocr_vl_1_5_llm_xh2a_export_hmonnx.py
# Description:
#   Export utilities for paddleocr_vl_1_5 in HOUMO AI xh2modelzoo.
#
...
from xh_model_zoo.xh_llm.models.paddleocr_vl import PaddleOCRVL_HFCompatible
from xh_model_zoo.xh_llm.models.paddleocr_vl_1_5 import PaddleOCRVLProcessor, XHPaddleOCRVLLLMModel
from xh_model_zoo.utils.memory_tracker import MemoryTracker
from xh_model_zoo.utils.time_profiler import TimeProfiler


def _preprocess_image_for_task(
    image: Image.Image, task: str
...
def parse_arguments():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="xh2modelzoo/xh_model_zoo/xh_llm/models/paddleocr_vl_1_5/paddleocr_vl_1_5_llm_config.py",
    )
    parser.add_argument(
...
def _export_impl(cfg, args):
    ...
    if True:
        ...
        prefill_onnx_file = xhmodel_export_onnx(
            ...
            f"paddleocr_vl_instruct_llm_prefill",
            execution_device,
            dtype,
            logger,
            is_valid_model,
