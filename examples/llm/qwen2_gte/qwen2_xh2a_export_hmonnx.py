...
#
# File: qwen2_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/qwen2_gte/qwen2_xh2a_export_hmonnx.py
#
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "gte_qwen2", config, work_dir)
