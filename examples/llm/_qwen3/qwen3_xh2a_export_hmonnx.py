...
#
# File: qwen3_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/_qwen3/qwen3_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models._qwen3 import Qwen3ConvertConfig
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "Qwen3ForCausalLM", config, str(work_dir))
