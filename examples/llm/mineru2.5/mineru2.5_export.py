...
#
# File: mineru2.5_export.py
# Description:
#   Example script: llm/mineru2.5/mineru2.5_export.py
#
...
def main(args):
    ...
    model_path = "/data02/datasets/mineru2.5"
    ...
    Qwen2VLConverterXH2a.convert(model_path, config, work_dir)
