...
#
# File: qwen2_legacy_xh2a_hmonnx_test.py
# Description:
#   Example script: llm/qwen2_legacy/qwen2_legacy_xh2a_hmonnx_test.py
#
...
def main(args):
    ...
    inference_engine = Qwen2LegacyInference(args.config, fast_mode=args.fast)
    ...
    wraped_hf_model = Qwen2LegacyHFCompatible.to_hf_compatible(hf_model_path, inference_engine)
