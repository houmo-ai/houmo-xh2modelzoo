...
#
# File: qwen2_legacy_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/qwen2_legacy/qwen2_legacy_xh2a_export_hmonnx.py
#
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "Qwen2ForCausalLM_legacy", config, str(work_dir))
