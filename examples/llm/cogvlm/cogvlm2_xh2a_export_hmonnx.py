...
#
# File: cogvlm2_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/cogvlm/cogvlm2_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models.cogvlm2 import CogVLM2ConvertConfig, VisionConfig
...
def main(args):
    ...
    config = CogVLM2ConvertConfig(
        batch_size=args.batch_size,
        context_length=args.context_length,
        input_sequence_length=args.input_sequence_length,
        quant_scheme=quant_scheme,
        quant_weight=args.quant_weight,
        vision_config=VisionConfig(image_size=1344, patch_size=14),
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="data/models/Qwen2.5-3B-Instruct")
