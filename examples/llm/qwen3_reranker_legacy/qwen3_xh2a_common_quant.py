...
#
# File: qwen3_xh2a_common_quant.py
# Description:
#   Example script: llm/qwen3_reranker_legacy/qwen3_xh2a_common_quant.py
#
...
def parse_arguments():
    ...
    parser.add_argument("--model", type=str, default="/data02/datasets/Qwen3-Reranker-8B")
...
def main():
    ...
    if not args.skip_gptq:
        ...
        gptq_config = dict(
            calib_dataset="./T2Reranking_Data/data/dev-00000-of-00001-65d96bde8023d9b9.parquet",
            calib_samples=512,
            seqlen=512,
            w_clip=True,
            w_bits=args.w_bits,
