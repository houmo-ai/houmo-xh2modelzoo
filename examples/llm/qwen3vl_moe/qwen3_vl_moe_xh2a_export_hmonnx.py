...
#
# File: qwen3_vl_moe_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/qwen3vl_moe/qwen3_vl_moe_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models.qwen3_vl_moe import Qwen3_VLConvertConfig, VisualConfig
from xh_model_zoo.xh_llm.models.qwen3_vl_moe import Qwen3VLMoeForConditionalGeneration
...
def main(args):
    ...
    native_model = Qwen3VLMoeForConditionalGeneration.from_pretrained(
        hf_model_path,
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "Qwen3VLMoeForConditionalGeneration", config, work_dir)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--model", type=str, default="weights/Qwen3-VL-2B-Instruct")
