...
#
# File: qwen3_vl_moe_xh2a_demo.py
# Description:
#   Example script: llm/qwen3vl_moe/qwen3_vl_moe_xh2a_demo.py
#
...
from xh_model_zoo.xh_llm.models.qwen3_vl_moe import Qwen3VLMoeONNXModel
...
def parse_arguments():
    ...
    parser.add_argument("--model_type", type=str, default="moe", choices=["2B", "4B", "8B","moe"])
...
def main():
    ...
    xh_model: Qwen3VLMoeONNXModel = Qwen3VLMoeONNXModel(
    ...
    from xh_model_zoo.xh_llm.models.qwen3_vl_moe import Qwen3VLProcessor
