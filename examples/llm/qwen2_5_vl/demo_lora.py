...
# File: demo_lora.py
# Description:
#   Example script: llm/qwen2_5_vl/demo_lora.py
#
...
def get_args():
    ...
    parser.add_argument("--gptq_model_path", type=str, default="weights/qwen2_5vl-7b_lora_11-15")
    parser.add_argument("--response_emotion_path", type=str, default="data/量化示例数据_/response_emotion_task/response_emotion")
