...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Qwen3.5 hmonnx inference demo",
    ...
    parser.add_argument(
        ...
        help="Path to meta.json generated by qwen3_5_xh2a_export_hmonnx.py",
    )
...
def main():
    ...
    print("Interactive Qwen3.5 hmonnx chat, type '/exit' to quit.", flush=True)
    history = []
    while True:
        try:
            prompt = input("\nUser: ").strip()
