...
#
# File: fm9g_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/fm9g/fm9g_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models.fm9g import FM9GConvertConfig
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "FM9GForCausalLM", config, str(work_dir))


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--model", type=str, default="data/models/CPM-9G-8B")
