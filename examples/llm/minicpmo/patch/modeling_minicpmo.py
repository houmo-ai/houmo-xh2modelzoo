...
from .configuration_minicpm import ConditionalChatTTSConfig, MiniCPMOConfig
from .modeling_navit_siglip import SiglipVisionTransformer
from .resampler import Resampler
from .utils import NumberToTextConverter, VoiceChecker, sentence_end
...
class ConditionalChatTTS(PreTrainedModel):
    ...
    def generate(
        ...
        Args:
            ...
            logits_warpers (List[LogitsProcessor], optional): List of logits warpers. Defaults to [].
