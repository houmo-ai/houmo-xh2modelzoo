...
from xh_model_zoo.xh_llm.models.minicpmo import MiniCPMO_HFCompatible, XHMiniCPMOTTSModel
...
def main(args):
    ...
    xh_model: XHMiniCPMOTTSModel = MODELS.build(cfg.model)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/minicpmo/tts/minicpmo_tts_7b_xh2a_2k.py", type=str)
