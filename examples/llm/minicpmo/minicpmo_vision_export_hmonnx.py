...
#
# File: minicpmo_vision_export_hmonnx.py
# Description:
#   Example script: llm/minicpmo/minicpmo_vision_export_hmonnx.py
#
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "MiniCPMOVisionEncoder", config, str(work_dir))
