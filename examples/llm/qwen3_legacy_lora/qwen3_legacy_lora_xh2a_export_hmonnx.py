...
#
# File: qwen3_legacy_lora_xh2a_export_hmonnx.py
# Description:
#   Example script: llm/qwen3_legacy_lora/qwen3_legacy_lora_xh2a_export_hmonnx.py
#
...
from xh_model_zoo.xh_llm.models.qwen3_legacy_lora import Qwen3LegacyLoRAConvertConfig
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        LLMConverter.from_pretrained(hf_model_path, "Qwen3ForCausalLM_LoRA", config, str(work_dir))
