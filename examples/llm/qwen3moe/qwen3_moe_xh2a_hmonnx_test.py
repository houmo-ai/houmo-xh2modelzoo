...
#
# File: qwen3_moe_xh2a_hmonnx_test.py
# Description:
#   Example script: llm/qwen3moe/qwen3_moe_xh2a_hmonnx_test.py
#
...
def main(args):
    ...
    inference_engine = Qwen3MoeInference(args.config, fast_mode=args.fast)
    ...
    wraped_hf_model = Qwen3MoeHFCompatible.to_hf_compatible(hf_model_path, inference_engine)
