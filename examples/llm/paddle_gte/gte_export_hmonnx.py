...
#
# File: gte_export_hmonnx.py
# Description:
#   Example script: llm/paddle_gte/gte_export_hmonnx.py
#
...
def main(args):
    ...
    Gte_xh2_model = GteConverterXH2a(config)
    Gte_xh2_model.convert(hf_model_path, config, work_dir)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--debug", action="store_true", help="debug mode")
    parser.add_argument("--model", type=str, default="/data02/datasets/paddle_gte")
