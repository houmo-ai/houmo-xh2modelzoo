...
def demo(model, processor):
    ...
    from xh_model_zoo_new.xh_llm.quantization.quarot import utils
...
def main():
    ...
    if not args.skip_quarot:
        ...
        if not os.path.exists(filename):
            from xh_model_zoo_new.xh_llm.quantization.quarot.quantizer_utils import quarot
    ...
    if not args.skip_gptq:
        from xh_model_zoo_new.xh_llm.quantization.quarot.quantizer_utils import gptq
