...
from .qwen3_hmonnx_inference import XHQwen3LegacyHMONNXModel


class XHQwen3LegacyModelConfig(TextLLMModelConfig):
    pass


@register_llm_model("Qwen3ForCausalLM_legacy")
class XHQwen3LegacyModel(TextLLMModel):
