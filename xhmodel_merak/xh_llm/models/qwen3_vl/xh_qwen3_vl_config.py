...
class XHQwen3VLVisualConfig(HFModelConfig):
    def __init__(
        self,
        *,
        max_size_w: int,
...
class XHQwen3VLModelConfig(VisionLLMModelConfig):
    def __init__(
        self,
        *,
        model_name: str,
        ...
        use_cache: bool = True,
        visual_config: dict | XHQwen3VLVisualConfig | None = None,
        **kwargs,
    ):
        super().__init__(
        ...
        if visual_config is None:
            raise ValueError("visual_config must be provided for XHQwen3VLModelConfig")
        if isinstance(visual_config, dict):
            ...
            visual_config = XHQwen3VLVisualConfig(**visual_config)
