...
# Description:
#   Qwen3-VL image preprocessing adapted for the xh2 model zoo (xh2modelzoo).
...
class Qwen2_5_VLImageProcessor(Qwen2VLImageProcessor):
    ...
    def preprocess(
        ...
        if images is not None:
            ...
            data.update(
                {"pixel_values": pixel_values, "image_grid_thw": vision_grid_thws, "hm_pixel_values": hm_pixel_values}
            )
