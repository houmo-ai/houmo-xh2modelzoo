...
#
# File: image_processing_qwen3_5.py
# Description:
#   Qwen3.5 image preprocessing adapted for the xh2 model zoo (xh2modelzoo).
...
class Qwen3_5ImageProcessor(Qwen2VLImageProcessor):
    ...
    (5-D tensor [B, C, T, H, W]) needed by the wrap vision model."""
