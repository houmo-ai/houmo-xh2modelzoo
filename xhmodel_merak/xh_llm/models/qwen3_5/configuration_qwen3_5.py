...
#
# Source: vllm 0.9.0 — https://github.com/vllm-project/vllm/archive/refs/tags/v0.6.5.tar.gz
#
# File: configuration_qwen3_5.py
# Description:
#   Configuration class for qwen3_5 in HOUMO AI xh2modelzoo.

from ._compat import PreTrainedConfig, RopeParameters, layer_type_validation
