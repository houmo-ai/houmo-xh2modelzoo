...
# Description:
#   MTP (Multi-Token Prediction) draft model for Qwen3.5 speculative decoding.
#   Built directly with xhquant ops — no HF model wrapping needed.

"""
Qwen3.5 MTP draft model implementation.
...
main model. It uses gated attention (same as Qwen3.5 main model) and
