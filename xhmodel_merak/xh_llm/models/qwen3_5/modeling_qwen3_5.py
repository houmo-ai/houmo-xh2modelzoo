...
#
# Source: transformers 4.48.0 - https://github.com/huggingface/transformers/archive/refs/tags/v4.48.0.tar.gz
#
# File: modeling_qwen3_5.py
# Description:
#   Modeling implementation for qwen3_5 in HOUMO AI xh2modelzoo.
...
# --- Compatibility: use absolute transformers imports + local compat shims ---
from ._compat import (
    auto_docstring,
    capture_outputs,
    init,
