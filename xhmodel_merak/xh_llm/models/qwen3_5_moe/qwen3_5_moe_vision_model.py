...
from transformers.models.qwen3_5_moe.modeling_qwen3_5_moe import Qwen3_5MoeForConditionalGeneration as XHQwen3_5MoeForConditionalGeneration
...
class XHQwen3_5MoeVisionModel(BaseVisionModel):  # noqa: N801
    ...
    def __init__(self, config: XHQwen3_5Moe_VisualConfig):
        ...
        self.config = cast(XHQwen3_5Moe_VisualConfig, self.config)
    ...
    def _to_fronted(self, wrap_model):
        ...
        try:
            onnx_file = str(Path(work_dir) / "onnx" / "qwen3_5_moe_visual.onnx")
