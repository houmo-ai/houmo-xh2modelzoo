...
#
# File: qwen3_5_moe_model.py
# Description:
#   Qwen3.5 MoE model adapted for the xh2 model zoo (xh2modelzoo).
...
class XHQwen3_5MoeModel(VisionLLMModel):  # noqa: N801
    ...
    def _wraped_post(self, hf_model: Qwen3_5MoeForConditionalGeneration):
        ...
        if self.use_cache:
            ...
            self.kvcache_config.linear_kv_cache_config.conv_dim = linear_attn.conv_dim
            self.kvcache_config.linear_kv_cache_config.conv_kernel_size = linear_attn.conv_kernel_size
            self.kvcache_config.linear_kv_cache_config.num_v_heads = linear_attn.num_v_heads
            self.kvcache_config.linear_kv_cache_config.head_k_dim = linear_attn.head_k_dim
            self.kvcache_config.linear_kv_cache_config.head_v_dim = linear_attn.head_v_dim
            self.kvcache_config.linear_kv_cache_config.num_layers = len(self.linear_attention_layer_indices)
