...
class XHQwen3_5Moe_VisualConfig(HFModelConfig):  # noqa: N801
    def __init__(
        self,
        *,
        max_size_w: int,
...
class XHQwen3_5MoeModelConfig(VisionLLMModelConfig):  # noqa: N801
    def __init__(
        self,
        *,
        model_name: str,
        ...
        use_cache: bool = True,
        visual_config: dict | XHQwen3_5Moe_VisualConfig | None = None,
        **kwargs,
    ):
        super().__init__(
        ...
        if isinstance(visual_config, dict):
            ...
            visual_config = XHQwen3_5Moe_VisualConfig(**visual_config)
