...
class _Qwen3_5MoeVisionAttention(DynamicModule):  # noqa: N801
...
class _Qwen3_5MoeVisionBlock(DynamicModule):  # noqa: N801
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        pass
...
class _Qwen3_5MoeVisionPatchEmbed(DynamicModule):  # noqa: N801
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        self.only_first_block = False
        self.max_size_w = cfg.max_size_w
...
class _Qwen3_5MoeVisionPatchMerger(DynamicModule):  # noqa: N801
    def _setup(self, cfg: ConfigDict):
        pass
...
class _Qwen3_5MoeVisionModel(DynamicModule):  # noqa: N801
    @torch.no_grad()
    def _setup(self, cfg: ConfigDict):
        self.only_first_block = False
        self.patch_size = cfg.patch_size
