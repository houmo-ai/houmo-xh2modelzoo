...
class cus_ZImagePipeline(ZImagePipeline):
    ...
    def transformer_infer(self, latent_model_input_list, timestep_model_input, prompt_embeds_model_input):
        ...
        # latent = torch.load("<sample_dir>/dit/input/latent.pt").cuda() # [16, 1, 128, 128]
        # cap_feats = torch.load("<sample_dir>/dit/input/prompt.pt").cuda() # [15, 2560]
        ...
        with torch.no_grad():
            ...
            #     from ._dit_model import register_wrap_cls as llm_register_wrap_cls
