...
from ...builder import LLM_COMPATIBLE_MODULES, register_other_model
...
@register_other_model("XHQwen3TTSTalker")
class XHQwen3TTSTalker(LLMBaseModel):
    WORKFLOW_CLS = "xhmodel_merak.xh_other_model.models.qwen3_tts.workflow:Qwen3TTSWorkflow"
