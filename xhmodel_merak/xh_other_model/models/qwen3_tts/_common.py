...
@XHLLM_TRACEABLE_MODULES.register_module(
    {
        Qwen3TTSRMSNorm: "Qwen3TTSRMSNorm",
    }
)
class _Qwen3TTSRMSNorm(DynamicModule):
...
@FUNCTION_REWRITER.register_rewriter(func_name="transformers.generation.utils.GenerationMixin._sample")
def _transformers_generation_utils_GenerationMixin_sample(  # noqa: C901, N802
    self,
