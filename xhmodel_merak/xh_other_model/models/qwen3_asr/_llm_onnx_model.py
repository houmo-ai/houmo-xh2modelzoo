...
@register_other_model("XHQwen3ASRHMONNXModel", master=False)
class XHQwen3ASRHMONNXModel(LLMONNXModel):
    ...
    def forward(
        ...
        # print(f"prefill_session output: {(out)}") # tensor([[-1.9004, 14.5938, -0.5117,  ...,  2.4102,  1.0693,  0.3779]],
