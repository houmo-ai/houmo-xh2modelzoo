# -*- coding: utf-8 -*-
# Copyright 2024 ModelCloud/GPTQModel contributors. All rights reserved.
# Copyright 2025 HOUMO AI. All rights reserved.
#
# Modifications:
# - Adapted GPTQ quantized linear utilities for xh2modelzoo SD3 export paths.
#
...
# See licenses/GPTQModel/LICENSE for the upstream Apache-2.0 license text.
#
# File: qlinear_cuda_old_non_zero.py
# Description:
#   GPTQ non-zero CUDA quantized linear layer adapted for xh2modelzoo develop SD3 export.
