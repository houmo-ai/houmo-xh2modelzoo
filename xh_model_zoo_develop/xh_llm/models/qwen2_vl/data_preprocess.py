...
# Description:
#   Qwen2-VL calibration / dataset utilities adapted for the xh2 model zoo (xh2modelzoo).
...
class Qwen2VLDataPreprocess(nn.Module):
    def __init__(self, token_embedding: nn.Embedding, input_sequence_length: int = 256):
        super().__init__()
    ...
    def forward(self, data: Union[dict, tuple, list]):
        ...
        return (
            ...
            position_ids.to(torch.int32).to(device),
        )
