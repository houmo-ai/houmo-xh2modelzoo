...
#
# File: qwen2_5_vl_demo.py
# Description:
#   Qwen2.5-VL runtime demo adapted for the xh2 model zoo (xh2modelzoo).

import torch, torch.nn as nn, torch.nn.functional as F
from torch.fx import GraphModule
from typing import Optional, List, Tuple, Union
from transformers import AutoModelForCausalLM
from xh_model_zoo_develop.xh_llm.base_llm_infer_adapter import (
    BaseLLMHFCompatible,
    _LLMInfer,
...
from xh_model_zoo_develop.xh_llm.models.qwen2_5_vl.device_dtype_mixin import DeviceDtypeMixin
from xhquant.api import HMONNXInference
from xhquant.xhonnxruntime.hmonnx_graph_inference import HMONNXGrapInference
from xh_model_zoo_develop.xh_llm.models.builder import LLM_DYNAMIC_MODULES
