# Copyright 2025 HuggingFace Inc. and the Qwen3 team
...
#
# File: int_qwen_layer.py
# Description:
#   Qwen3 transformer layers adapted with singlequant modules for xh2modelzoo quantization.
