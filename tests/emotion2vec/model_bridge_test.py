...
def test_export_bridge_masks_tail_and_returns_frame_mask():
    from xhmodel_merak.xh_llm.models.emotion2vec.modeling_emotion2vec import Emotion2vecExportBridge

    bridge = Emotion2vecExportBridge(_FakeFunASRModel(), sampling_rate=16000, window_samples=256000)
    ...
    frame_features, frame_padding_mask = outputs
...
def test_export_bridge_does_not_use_tensor_item_for_valid_samples():
    from xhmodel_merak.xh_llm.models.emotion2vec.modeling_emotion2vec import Emotion2vecExportBridge
...
def test_export_bridge_validates_fixed_input_shape():
    from xhmodel_merak.xh_llm.models.emotion2vec.modeling_emotion2vec import Emotion2vecExportBridge
