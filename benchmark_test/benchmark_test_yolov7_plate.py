...
def test_yolov7(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolov7_plate_640x640.onnx"
...
if __name__ == "__main__":
    test_yolov7("ONNX", w_bit=8, a_bit=16)
