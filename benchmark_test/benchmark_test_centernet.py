...
def test_centernet(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/centernet_resnet18_140e_coco_20210705_093630-bb5b3bf7.sim.onnx"
    ...
    cos_sim = torch.cosine_similarity(hm_out[0], torch.from_numpy(outputs[0]).to(hm_out[0].device) )
...
if __name__ == "__main__":
    test_centernet("ONNX", w_bit=8, a_bit=16)
