...
def test_rtdetr(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/detr_1312_prepared.sim.onnx"
...
if __name__ == "__main__":
    test_rtdetr("ONNX", w_bit=8, a_bit=16)
