...
def test_qwen2vl(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    model_file = os.path.join(current_dir, "examples/llm/cogvlm/cogvlm2_xh2a_export_hmonnx.py")
    ...
    if w_bit < 8:
        ...
        command = [
            ...
            "--model", "/data02/datasets/cogvlm2-llama3-chat-19B",
            "--context-length", "2048",
