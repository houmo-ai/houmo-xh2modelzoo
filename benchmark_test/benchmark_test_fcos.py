...
def test_fcos(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/fcos_r50_caffe_fpn_gn-head_1x_coco.onnx"
...
if __name__ == "__main__":
    test_fcos("ONNX", w_bit=8, a_bit=16)
