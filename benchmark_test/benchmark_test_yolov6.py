...
def test_yolov6(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolo/yolov6m.onnx"
...
if __name__ == "__main__":
    test_yolov6("ONNX", w_bit=8, a_bit=16)
