...
def test_qwen2vl(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    original_version, need_rollback = check_and_set_transformers_version(target_version="4.46.1")
    ...
    model_file = os.path.join(current_dir, "examples/llm/qwen2-vl/qwen2-vl_xh2a_export_hmonnx.py")
    ...
    if w_bit < 8:
        ...
        command = [
            ...
            "--model", "/data02/datasets/Qwen2-VL-2B-Instruct",
            "--context-length", "2048",
...
if __name__ == "__main__":
    test_qwen2vl("ONNX", w_bit=8, a_bit=8)
