...
def test_yolov3(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolov3_640x640.onnx"
    ...
    cos_sim = torch.cosine_similarity(hm_out[-1], torch.from_numpy(outputs[0]).to(hm_out[-1].device) )
...
if __name__ == "__main__":
    test_yolov3("ONNX", w_bit=8, a_bit=16)
