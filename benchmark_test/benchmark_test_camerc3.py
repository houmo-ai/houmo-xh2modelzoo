...
def test_camerc3(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    import torch
    ...
    onnx_file = "data/models/modified_model_c3_camera_v2_960x544_si.onnx"
    ...
    cos_sim = torch.cosine_similarity(hm_out[-3], torch.from_numpy(outputs[-3]).to(hm_out[-3].device) )
...
if __name__ == "__main__":
    test_camerc3("ONNX", w_bit=8, a_bit=16)
