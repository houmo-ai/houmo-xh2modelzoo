...
def test_efficient(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/efficientnet/efficientnet_v2_m.onnx"
...
if __name__ == "__main__":
    test_efficient("ONNX", w_bit=8, a_bit=16)
