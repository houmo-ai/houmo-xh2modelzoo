...
def test_deeplabv3(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    if os.getenv("TEST_ALL_MODEL", "false") != "true":
        allure.attach(str(f"此模型Conv空洞卷积，转换过程过慢，，如想测试请发送TEST_ALL_MODEL"), "ACC/Cosim_/PPL", attachment_type=allure.attachment_type.TEXT)
        return
    ...
    onnx_file = "data/models/deeplabv3_1024x2048_cityscapes.onnx"
...
if __name__ == "__main__":
    test_deeplabv3("ONNX", w_bit=8, a_bit=16)
