...
def test_yolov5(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolov5s.onnx"
...
if __name__ == "__main__":
    test_yolov5("ONNX", w_bit=8, a_bit=16)
