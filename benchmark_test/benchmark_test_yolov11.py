...
def test_yolov11(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolo11m.sim.onnx"
...
if __name__ == "__main__":
    test_yolov11("ONNX", w_bit=8, a_bit=16)
