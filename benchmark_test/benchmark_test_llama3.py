...
def test_llama3(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    # onnx_file = None
    ...
    model_file = os.path.join(current_dir, "examples/llm/llama/llama_xh2a_export_hmonnx.py")
    ...
    if w_bit < 8:
        ...
        command = [
            ...
            "--model", "/data01/datasets/llama3-8b-hf",
            "--context-length", "2048",
...
if __name__ == "__main__":
    test_llama3("ONNX", w_bit=8, a_bit=8)
