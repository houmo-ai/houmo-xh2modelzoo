...
def test_yolov8(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolov8m_640_640.onnx"
...
if __name__ == "__main__":
    test_yolov8("ONNX", w_bit=8, a_bit=16)
