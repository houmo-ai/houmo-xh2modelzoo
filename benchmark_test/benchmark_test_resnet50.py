...
def test_resnet50(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    import torch
    ...
    onnx_file = "data/models/resnet50_224x224.onnx"
...
if __name__ == "__main__":
    test_resnet50("ONNX", w_bit=8, a_bit=16)
