...
def test_yolov10(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    import torch
    ...
    onnx_file = "data/models/yolov10b.onnx"
...
if __name__ == "__main__":
    test_yolov10("ONNX", w_bit=8, a_bit=16)
