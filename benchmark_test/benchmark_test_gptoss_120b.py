...
def test_qwen2(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    if gptoss_120b_half_path is None:
    ...
    model_file = os.path.join(current_dir, "examples/llm/gpt-oss/gpt_oss_with_mask_xh2a_export_hmonnx.py")
    ...
    if w_bit < 8:
        ...
        command = [
            ...
            "--model", "/data02/datasets/gpt-oss-20b",
            "--context-length", "2048",
