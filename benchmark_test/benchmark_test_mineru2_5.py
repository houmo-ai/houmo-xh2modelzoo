...
def test_mineru(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    model_file = os.path.join(current_dir, "examples/llm/mineru2.5/mineru2.5_export.py")
...
if __name__ == "__main__":
    test_mineru("ONNX", w_bit=8, a_bit=8)
