...
def test_qwen2gte(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    model_file = os.path.join(current_dir, "examples/llm/qwen2_gte/qwen2_xh2a_export_hmonnx.py")
...
if __name__ == "__main__":
    test_qwen2gte("ONNX", w_bit=8, a_bit=8)
