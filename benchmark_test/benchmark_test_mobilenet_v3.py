...
def test_mobilenet(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/mobileNetv3.onnx"
...
if __name__ == "__main__":
    test_mobilenet("ONNX", w_bit=8, a_bit=16)
