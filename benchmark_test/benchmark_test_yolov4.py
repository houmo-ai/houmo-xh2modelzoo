...
def test_yolov4(trace_method: Literal["FX", "DFX", "ONNX"], w_bit: int, a_bit: int):
    ...
    onnx_file = "data/models/yolo/yolov4m.onnx"
...
if __name__ == "__main__":
    test_yolov4("ONNX", w_bit=8, a_bit=16)
