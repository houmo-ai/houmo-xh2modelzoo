...
from xh_model_zoo_develop.xh_llm.models.qwen3.qwen3_converter import Qwen3Converter, Qwen3ConverterConfig
...
def parse_args():
    ...
    parser.add_argument("--tasks", nargs="+", type=str, default=["gsm8k"], help="List of tasks for evaluation")
