...
#
# File: qwen2_5_vl_export.py
# Description:
#   Qwen2.5-VL ONNX export adapted for the xh2 model zoo (xh2modelzoo).
...
from xh_model_zoo_develop.xh_llm.models.qwen2_5_vl.qwen2_5_vl_converter_v2 import (
    Qwen25VLConverter,
    Qwen25VLConverterConfig,
    VisionConfig,
)
from xhquant.api import DeviceType, xhquant_init, QuantScheme, get_root_logger  # isort:skip
from xh_model_zoo_develop.utils import MemoryTracker  # isort:skip
from xh_model_zoo_develop.utils import TimeProfiler  # isort:skip
...
def main(args):
    ...
    with TimeProfiler("convert", logger), MemoryTracker("cuda:0", "convert", logger):
        Qwen25VLConverter.convert_and_export(hf_model_path, config, work_dir, generate_golden=args.generate_golden)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--generate-golden", action="store_true", help="generate golden data")
    parser.add_argument(
        "--quant_weight",
        type=str,
        default=None,
