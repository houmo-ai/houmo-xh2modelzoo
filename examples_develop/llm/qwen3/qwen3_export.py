...
from xh_model_zoo_develop.xh_llm.models.qwen3.qwen3_converter import Qwen3ConverterConfig, Qwen3Converter
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="work_dirs/Qwen3-0.6B-gptqmodel-4-bit-64g",  # /data02/datasets/Qwen2.5-1.5B-Instruct-int4-sym-inc
    )
