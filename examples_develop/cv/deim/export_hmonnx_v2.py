...
#
# File: export_hmonnx_v2.py
# Description:
#   Export utilities for deim in HOUMO AI xh2modelzoo.
#
...
def main(args):
    ...
    if args.debug:
        ...
        fronted_graph_module = to_frontend_graph(model, FrontendType.TorchExport, [im_dummy])
