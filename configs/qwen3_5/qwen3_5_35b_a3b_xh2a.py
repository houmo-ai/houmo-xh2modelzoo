...
# NOTE: 35B-A3B uses qwen3_5_moe architecture → use the MoE export pipeline
# (examples/llm/qwen3_5_moe/qwen3_5_moe_xh2a_export_hmonnx.py)
# This config is a placeholder for the dense pipeline reference only.
