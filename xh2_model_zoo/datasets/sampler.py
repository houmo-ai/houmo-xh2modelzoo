...
from xhquant.utils.dist import get_dist_info, sync_random_seed

from ..registry import DATA_SAMPLERS
...
class InfiniteSampler(Sampler):
    ...
    def __init__(self, dataset: Sized, shuffle: bool = True, seed: Optional[int] = None) -> None:
        rank, world_size = get_dist_info()
        self.rank = rank
        self.world_size = world_size
