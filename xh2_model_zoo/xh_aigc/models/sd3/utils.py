...
def from_pretrained_diffusers(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
    """
    Standalone function to create a model from config without loading weights.
    This is a replacement for the original from_pretrained method.
    """
    ...
    if output_loading_info:
        # Return empty loading info since we didn't load weights
        loading_info = {
            "missing_keys": [],
            "unexpected_keys": [],
            "mismatched_keys": [],
            "error_msgs": ["No weights loaded - only model structure created"],
        }
...
from transformers.generation import CompileConfig, GenerationConfig, GenerationMixin
