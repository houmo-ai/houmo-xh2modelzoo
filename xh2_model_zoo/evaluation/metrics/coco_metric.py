...
from xhquant.utils.fileio import dump, get_local_path, load
from xhquant.utils.logger import MMLogger, get_root_logger

from ...datasets.api_wrappers import COCO, COCOeval, COCOevalMP
...
class CocoMetric(BaseMetric):
    ...
    def __init__(
        ...
        for metric in self.metrics:
            if metric not in allowed_metrics:
                raise KeyError(
                    "metric should be one of 'bbox', 'segm', 'proposal', " f"'proposal_fast', but got {metric}."
                )
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        """
        logger: MMLogger = get_root_logger()
