...
from xhquant.utils import mkdir_or_exist
from xhquant.utils.dist import is_main_process, master_only
...
class CityscapesMetric(BaseMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        eval_results = dict()
        logger.info(f"Evaluating results under {self.output_dir} ...")
