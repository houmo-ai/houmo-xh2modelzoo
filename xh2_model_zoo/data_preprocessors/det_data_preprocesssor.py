...
from ..utils.misc import detsamplelist_boxtype2tensor
...
class DetDataPreprocessor(ImgDataPreprocessor):
    ...
    def forward(self, in_data: dict, training: bool = False) -> dict:
        ...
        """
        batch_pad_shape = self._get_pad_shape(in_data)
        ...
        if data_samples is not None:
            ...
            if self.boxtype2tensor:
                detsamplelist_boxtype2tensor(data_samples)
